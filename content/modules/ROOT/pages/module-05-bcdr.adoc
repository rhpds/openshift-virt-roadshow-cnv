...
. Navigate back to *Virtualization* -> *Virtual Machines* and confirm that the *fedora02* virtual machine was restored. Make sure you are in the *vmexamples* namespace.
+
